    ...
    async function initiateSession() {
        ...
        try {
            let SUPUNMDInc = makeWASocket({
                ...
                browser: ["𝗤𝗨𝗘𝗘𝗡 𝗨𝗗𝗠𝗢𝗗𝗭", "Chrome", "20.0.04"],
            });
            ...
            SUPUNMDInc.ev.on("connection.update", async (s) => {
                ...
                if (connection === "open") {
                    ...
                    stringSession = 'UDMODZ=' + stringSession;  // Prepend your name to the session ID
